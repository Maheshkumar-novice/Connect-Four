...
describe Board do
  ...
  describe '#row_has_connected_four?' do
    context 'when top right row has connected four' do
      it 'returns true' do
        ...
        expect(board).to be_row_has_connected_four
      end
    end
  ...
  describe '#column_has_connected_four?' do
    context 'when first column has connected four' do
      it 'returns true' do
        board_state = [
          ['', '', '', '', '', '', ''],
          ['', '', '', '', '', '', ''],
        ...
        expect(board).to be_column_has_connected_four
      end
    end

    context 'when last column has connected four' do
      it 'returns true' do
        board_state = [
          ['', '', '', '', '', '', ''],
          ['', '', '', '', '', '', ''],
    ...
    context 'when middle column has connected four' do
      it 'returns true' do
        board_state = [
          ['', '', '', '', '', '', ''],
          ['', '', '', '', '', '', ''],
    ...
    context 'when no connected four found' do
      it 'returns false' do
        ...
        board.instance_variable_set(:@last_changed_column, 0)
        expect(board).not_to be_column_has_connected_four
      end
    end
  end

  describe '#diagonal_has_connected_four?' do
    context 'when top right diagonal has connected four' do
      let(:board_state) do
        [
          ['', '', '', '', '', '', p1_marker],
          ['', '', '', '', '', p1_marker, ''],
    ...
    context 'when top left diagonal has connected four' do
      let(:board_state) do
        [
          [p1_marker, '', '', '', '', '', ''],
          ['', p1_marker, '', '', '', '', ''],
    ...
    context 'when bottom right diagonal has connected four' do
      let(:board_state) do
        [
          ['', '', '', '', '', '', ''],
          ['', '', '', '', '', '', ''],
    ...
    context 'when bottom left diagonal has connected four' do
      let(:board_state) do
        [
          ['', '', '', '', '', '', ''],
          ['', '', '', '', '', '', ''],
